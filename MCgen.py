...
@client.event
async def on_ready():
    await client.change_presence(game=discord.Game(name='!gen Server 3242'))
    print('Ready, Freddy')

@client.event
async def on_message(message):
    if message.content.startswith('!test'):
        await client.send_message(message.author,'This a test new bot')
...
client.run('NDkzMDI4NDEzNzE2NTYxOTMw.Doy9Vw.ahuDiPZgVo5C-OZdBKuRXHhXPGA')  
